...
$(document).ready(function() {
  ...
  const canvasContainer = document.querySelector('.room-details-doughnut-wrapper');

  $(canvasContainer).append('<div class="room-details-chart-text-container"><span class="room-details-chart-text"><span class="room-details-chart-text__number">260</span> голосов</span></div>');

  const windowWidth = $(window).width();
  
  const canvas = document.querySelector('.room-details-chart').getContext('2d');
  ...
  const ctx = document.querySelector('.room-details-chart');
  ...
  const chartVoicesSum = $('.room-details-chart-text__number');
