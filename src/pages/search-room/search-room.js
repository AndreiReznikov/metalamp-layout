...
$(document).ready(function() {
  function simpleTemplating(data) {
    ...
    $.each(data, function(index, item){
        html += '<li class="pagination-list__item">' + '<a class="pagination-list__link" href="room-details.html">' + item + '</a>' + '</li>';
    });
    html += '</ul>';
    return html;
  }
  ...
  const $roomCard = $('.room-short-information-block');
  ...
  const showItemsNum = () => {
    ...
    let paginationItemsNum = $('.pagination-list__item').length;
    let paginationSubText = $('.pagination-text__num');
  ...
  const initializeSlick = () => {
    $('.data-container .room-short-information-block__slider').each(function() {
      const $item = $(this);
    ...
    $('.data-container .room-short-information-block__slider_width-arrays').each(function() {
      const $item = $(this);
